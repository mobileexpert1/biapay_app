...
class ShowRequestSummaryView extends GetView<RequestMoneyController> {
    ...
    return BiaScaffold(
      ...
      body: Column(crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          ...
          headingTextWidget(title: LocaleKeys.requesting_money_from.tr),
          summaryDetailWidget(),
          sendButtonWidget()
        ],
      ),
  ...
  sendButtonWidget(){
    return BiaButton.greenButtonInRow(
        ...
        text: LocaleKeys.request.tr, onPressed: (){
