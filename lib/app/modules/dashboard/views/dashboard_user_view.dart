...
import 'package:biapay_app/app/models/providers/user_summary_model.dart';
import 'package:biapay_app/app/models/summary_dummy_model.dart';
import 'package:biapay_app/app/models/summary_dummy_model.dart';
import 'package:biapay_app/app/models/summary_dummy_model.dart';
...
class DashboardUserView extends GetView<DashboardController> {
  ...
  Widget build(BuildContext context) {
    ...
    final usercontroller = Get.put(DashboardUserController());
    final profcontroller = Get.put(ProfilController());
    return
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            GetBuilder<MerchentProfileController>(builder: (profcontroller) {
              return BiaText(
                "${LocaleKeys.welcome.tr}, ${profcontroller.merchentProfile?.merchantProfile?.merchant?.merchantName.toString() ?? "User"}",
              ...
              children: [
                ...
                Expanded(
                  child: BiaDropdown<String>(
                      ...
                      // options: controller.
                      options:
                          // controller.amountPerShop.codeUnits,
                          [
// controller.timeModelList.value.length,
                        'Period 1',
                        'Period 2',
                        'Period 3',
                        'Period 4'
            ...
            Container(
              height: 100,
              padding: EdgeInsets.all(10.sp).copyWith(left: 15, right: 20),
              ...
              child: Row(
                children: [
                  ...
                  GetBuilder<DashboardUserController>(
                      builder: (usercontroller) {
                    return BiaText(
                      usercontroller.userModel?.userSummaryDTO?.totalTransactions.toString()??" ",
                ...
                child: SfCircularChart(
                    annotations: <CircularChartAnnotation>[
                      ...
                      CircularChartAnnotation(
                        ...
                        child: Text(
                          "Total\n Amount Sent \n" +
                              controller.amountPerShop.length.toString() +
                              " XAF",
                          // 'Total \n50,000 XAF',
