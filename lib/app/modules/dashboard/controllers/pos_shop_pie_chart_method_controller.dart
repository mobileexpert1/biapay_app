...
class PosShopPieMethodController extends GetxController {
  ...
  String amountPerShop = LocaleKeys.select_shop_to_view_pos_method.tr;
  ...
  filterBaseOnCategory(DashBoardPieModel? dashBoardPieModel) {
    ...
    if (paymentCategoryMap.isEmpty == true &&  amountPerShop != LocaleKeys.select_shop_to_view_pos_method.tr) {
      amountPerShop = LocaleKeys.no_data_found.tr;
    }
