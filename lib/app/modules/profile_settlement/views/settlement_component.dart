...
class SettleMentComponent extends StatelessWidget {
          ...
          children: [
            Column(
              ...
              children: [
                ...
                rowItemwidget(firstTitle: LocaleKeys.payment_method.tr,secondTitle:"" ),

                SizedBox(
                  height: 5.h,
                ),

                rowItemwidget(firstTitle: LocaleKeys.account_address.tr,secondTitle:"" ),
