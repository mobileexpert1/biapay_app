...
class BiaModelDropdown<T> extends StatefulWidget {
  final List<SecurityModel>? options;
...
class _BiaDropdownState<T> extends State<BiaModelDropdown<T?>> {
  @override
          ...
          children: [
            ...
            Container(
              ...
              decoration: BoxDecoration(
                  ...
                  borderRadius: BorderRadius.circular(5)),
              child: DropdownButtonFormField<SecurityModel>(
                ...
                items: widget.options?.map((SecurityModel value) {
                  return DropdownMenuItem<SecurityModel>(
                    value: value,
                    child: BiaText(value.question??""/*widget.displayName(value.question).toString()*/,
                ...
                onChanged: (value) {
                  print(value);
                  setState(() {
                   widget.controller!.text =  value?.question??"";
