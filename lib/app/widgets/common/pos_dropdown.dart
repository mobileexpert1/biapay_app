...
class BiaPosDropdown<T> extends StatefulWidget {
  final List<MerchantPosModel>? options;
...
class _BiaDropdownState<T> extends State<BiaPosDropdown<T?>> {
  @override
          ...
          children: [
            ...
            Container(
              ...
              decoration: BoxDecoration(
                  ...
                  borderRadius: BorderRadius.circular(5)),
              child: DropdownButtonFormField<MerchantPosModel>(
                ...
                items: widget.options?.map((MerchantPosModel value) {
                  return DropdownMenuItem<MerchantPosModel>(
                    value: value,
